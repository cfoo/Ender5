...
#define STRING_CONFIG_H_AUTHOR "(cFoo, Ender-5)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 600, 600, 200, 5000 }
...
//#define CLASSIC_JERK
  ...
  #if ENABLED(LIMITED_JERK_EDITING)https://youtu.be/W6zYvRgGr3Q
...
#define NOZZLE_TO_PROBE_OFFSET { -41, -14, -3.70 }
